...
source_adj as (
    ...
    from source_data a
        left join lkp_actvty_gl_sbldgr_nm b on a.gl_application_area_code = c.actvty_gl_app_area_cd
...
target_data as (
    select a.*,
        ...
        ) as reinsuranceassumedcededflag_error_flag
